...
for (var i=0;i<deleteList.length;i++) {
    ...
    deleteList[i].onclick = function () {
        itemList[this.index].firstElementChild.classList.remove('pitch-up');
